...
func TestMerkleBlock(t *testing.T) {
	...
	if !merkle.ValidateTree() {
		t.Fatal("Could not validate the tree")
	}
}
...
func TestMerkleTree1(t *testing.T) {
	...
	tree := bitcoinlib.NewMerkleTree(len(hexHashes))
	expectedRoot := "597c4bafe3832b17cbbabe56f878f4fc2ad0f6a402cee7fa851a9cb205f87ed1"
	hashes := [][]byte{}
	flags := []bool{}
	for _, hash := range hexHashes {
		dec, _ := hex.DecodeString(hash)
		hashes = append(hashes, dec)
	}
	for _ = range 31 {
...
func TestMerklePopulate2(t *testing.T) {
	...
	tree := bitcoinlib.NewMerkleTree(len(hexHashes))
	expectedRoot := "a8e8bd023169b81bc56854137a135b97ef47a6a7237f4c6e037baed16285a5ab"
	hashes := [][]byte{}
	flags := []bool{}
	for _, hash := range hexHashes {
		dec, _ := hex.DecodeString(hash)
...
func TestValidMerkleBlock(t *testing.T) {
	hexMerkleBlock := ""
	bytesMerkleBlock, _ := hex.DecodeString(hexMerkleBlock)
	block := bitcoinlib.NewMerkleBlockMessage()
	if _, err := block.Parse(bytesMerkleBlock); err != nil {
		t.Fatalf("Failed parsing merkle block: %s", err)
	}
	if !block.ValidateTree() {
		t.Fatalf("Failed validating block")
	}
}
